...
export const getMonthlyRevenue = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      "https://auction-plateform-xxjg.onrender.com/api/v1/superadmin/monthlyincome",
...
export const getAllUsers = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      "https://auction-plateform-xxjg.onrender.com/api/v1/superadmin/users/getall",
      { withCredentials: true }
    );
...
export const getAllPaymentProofs = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      "https://auction-plateform-xxjg.onrender.com/api/v1/superadmin/paymentproofs/getall",
      { withCredentials: true }
    );
    dispatch(
...
export const deletePaymentProof = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `https://auction-plateform-xxjg.onrender.com/api/v1/superadmin/paymentproof/delete/${id}`,
      { withCredentials: true }
    );
...
export const getSinglePaymentProofDetail = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      `https://auction-plateform-xxjg.onrender.com/api/v1/superadmin/paymentproofDetails/${id}`,
      { withCredentials: true }
    );
    dispatch(
  ...
  try {
   console.log("id url",id);
    const response = await axios.put(
      `https://auction-plateform-xxjg.onrender.com/api/v1/superadmin/paymentproof/status/update/${id}`,
      { status, amount },
...
export const deleteAuctionItem = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `https://auction-plateform-xxjg.onrender.com/api/v1/superadmin/auctionitem/delete/${id}`,
      { withCredentials: true }
    );
