...
export const getAllAuctionItems = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      "https://auction-plateform-xxjg.onrender.com/api/v1/auctionitem/allItems",
...
export const getMyAuctionItems = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      "https://auction-plateform-xxjg.onrender.com/api/v1/auctionitem/myitems",
      { withCredentials: true }
    );
...
export const getAuctionDetail = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      `https://auction-plateform-xxjg.onrender.com/api/v1/auctionitem/allItems/auction/${id}`,
      { withCredentials: true }
    );
...
export const createAuction = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      "https://auction-plateform-xxjg.onrender.com/api/v1/auctionitem/create",
      data,
      {
        withCredentials: true,
...
export const republishAuction = (id, data) => async (dispatch) => {
  ...
  try {
    const response = await axios.put(
      `https://auction-plateform-xxjg.onrender.com/api/v1/auctionitem/item/republish/${id}`,
      data,
      {
        withCredentials: true,
...
export const deleteAuction = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `https://auction-plateform-xxjg.onrender.com/api/v1/auctionitem/delete/${id}`,
      {
        withCredentials: true,
      }
    );
