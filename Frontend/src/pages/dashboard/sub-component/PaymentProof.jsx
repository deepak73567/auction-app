...
export const Drawer = ({ setOpenDrawer, openDrawer }) => {
  ...
  console.log("singlurl",singlePaymentProof.proof?.url)
  ...
  console.log("id",singlePaymentProof._id);
  return (
    <>
      <section
        className={`fixed ${
          openDrawer && singlePaymentProof.userId ? "bottom-0" : "-bottom-399"
        }  left-0 w-full transition-all duration-300  bg-[#00000087] flex items-end`}
      >
        <div className="bg-white h-fit transition-all duration-300 w-full">
          <div className="w-full px-5 py-8 max-h-[810px] sm:max-w-[540px] sm:m-auto">
