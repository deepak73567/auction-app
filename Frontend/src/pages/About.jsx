  ...
  return (
    <>
      <section className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] gap-7 flex flex-col min-h-screen py-4 justify-center">
        <div>
          <h1
            className={`text-purple-400 text-2xl font-bold mb-2 min-[480px]:text-4xl md:text-6xl xl:text-7xl 2xl:text-8xl`}
          >
            About Us
          </h1>
        ...
        <div>
          ...
          <p className="text-xl text-stone-600">
            Founded by <span className="text-[#2bcdd6] underline ">CodeWithTech</span>, PrimeBid was born out of a passion for
        ...
        <div>
          <p className="text-purple-400 text-xl font-bold mb-3">
            Thank you for choosing WinWager. We look forward to being a part of
